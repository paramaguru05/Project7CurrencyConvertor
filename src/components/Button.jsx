...
const Button = () => {
  ...
  return (
    <footer className={`${showButton?`block`:`hidden`} px-5 rounded-lg md:w-2/3 bg-blue-100 lg:container buttonComponentsWidth  mx-auto transition-all ease-linear duration-700 buttonComponentsHight`}>
        <div className='mt-12 pt-5 mx-auto  grid grid-cols-3 gap-10'>
